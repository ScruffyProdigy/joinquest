...
test.describe.skip('App E2E Tests', () => {
  ...
  test('displays the main heading', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: 'Find a game', includeHidden: true })).toBeVisible()
  })

  test('has proper heading structure', async ({ page }) => {
    // Check that the heading is an h1
    await expect(page.getByRole('heading', { level: 1, name: 'Find a game', includeHidden: true })).toBeVisible()
  })
  ...
  test('has accessible content structure', async ({ page }) => {
    ...
    const heading = page.getByRole('heading', { name: 'Find a game', includeHidden: true })
